# Generated by Django 3.0.5 on 2020-10-03 09:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_borrowed', models.DateField(default=datetime.datetime(2020, 10, 3, 17, 6, 46, 260647))),
                ('due_back', models.DateField(default=datetime.datetime(2020, 10, 18, 17, 6, 46, 260647))),
                ('imprint', models.IntegerField(primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.CharField(default=None, max_length=13)),
                ('ISBN', models.CharField(max_length=13)),
                ('imprint', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('regular', 'Student/Teacher'), ('manager', 'Book Manager'), ('head', 'Administrator')], default='regular', max_length=200)),
