...
class UserManager(BaseUserManager):
    def create_user(self, email, password=None,is_staff, is_superuser, first_name=None, last_name=None, username=None,id_num=None, role=None, security_question=None, security_answer=None):
        if not email:
